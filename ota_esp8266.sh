...
echo "[INFO]: OTA upload in progress..."
# First we check if esp is ready.
# TODO: Check if esp is ready for OTA upload using ping.
# if [ ! -e $DEFAULT_PORT ];then
#     echo "[ERROR]: Unable to locate the device on "$DEFAULT_PORT" Aborted..."
#     exit
# fi

/home/lyonbach/.arduino15/packages/esp8266/tools/python3/3.7.2-post1/python3 /home/lyonbach/.arduino15/packages/esp8266/hardware/esp8266/2.6.3/tools/espota.py \
-i 192.168.0.22 \
-p 8266 \
--auth= -f $BUILT_BIN
